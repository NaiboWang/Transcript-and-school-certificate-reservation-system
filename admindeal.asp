...
<div class="atshowa">
				...
				<div align="center" style="font-family:'微软雅黑'; color:#000">
				  <p><%
					...
					Command1.CommandText  = "update 成绩预约 set 状态 = '已处理',回复 = '"& request.Form("pass" & request.Form("IDS") ) &"' where ID = "& request.Form("IDS") 
					elseif request.Form("get") = "拒绝" then
					Command1.CommandText  = "update 成绩预约 set 状态 = '已拒绝',回复 = '"& request.Form("nopass" & request.Form("IDS") ) &"' where ID = "& request.Form("IDS")
					end if
					Command1.Execute()
				  ...
				  %>成功，点击下方按钮返回。</p>
				  <p >
				    <a href="score.asp"><input type="button" name="get" id="get" value="返回" style="font-size: 16px;
