...
<div class="atshowa">
				...
				<div align="center" style="font-family:'微软雅黑'; color:#000">
				  <p><%
					...
					Command1.CommandText  = "update 在校证明预约 set 状态 = '已处理',回复 = '"& request.Form("pass") &"' where ID = "& request.Form("IDS") 
					elseif request.Form("get") = "拒绝" then
					Command1.CommandText  = "update 在校证明预约 set 状态 = '已拒绝',回复 = '"& request.Form("nopass") &"' where ID = "& request.Form("IDS")
					end if
					Command1.Execute()
