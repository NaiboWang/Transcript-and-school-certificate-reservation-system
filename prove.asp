...
Recordset7_cmd.CommandText = "SELECT * FROM 在校证明预约 WHERE 状态='未处理' order by 学号 asc,时间 desc,数量 asc" 
...
%>
 ...
 <div id="list_wrap"><!--新闻内容-->
	<div id="list_main">
		<div class="maindiv">
				<div class="atshowa">
					<div class="atshowname" style="text-align:center;color:#009;font-size:23px;font-weight:bold;line-height:1.5em; font-family:'微软雅黑';margin-bottom:10px;height:auto!important">在校证明项目基本信息</div>
				  <div class="atshowb">
...
%>
                    ...
                    <form name="form1" method="post" action="provedeal.asp" onSubmit="">
