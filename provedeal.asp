...
<div class="atshowa">
				...
				<div align="center" style="font-family:'微软雅黑'; color:#000">
                 <form name="form1" method="post" action="provedealup.asp" onSubmit="return check()">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("身份证号").Value)%></td>
     <td align="right">性别：</td>
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("性别").Value)%></td>
      </tr>
      
    
      
       <tr id="tdate" style="height:40px; ">
      <td align="right">入学年份：</td>
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("入学年份").Value)%></td>
      <td align="right" style="min-width:170px">电话/手机号码：</td>
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("电话号码").Value)%></td>
      </tr>
     
      <tr id="tmajor" style="height:40px; ">
      <td align="right">专业：</td>
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("专业").Value)%></td>
      <td align="right">班级：</td>
      <td bgcolor="#FFFFFF" id="nameChange" ><%=(Recordset1.Fields.Item("班级").Value)%></td>
      </tr>
     ...
     <tr>
      ...
      <tr>
       <td  align="right" style="height:40px; min-width:130px">理由（备注）：</td>
  ...
  <td  ><input name="pass" type="text" id="pass"  placeholder="在此输入此项目通过的原因" value="通过"  ></td>
                    ...
                    <td  align="right" style="height:40px; ">拒绝回复：</td>  
				      <td ><input name="nopass" type="text" id="nopass"  placeholder="在此输入此项目未通过的原因" value="不符合规范"  ></td>
               </tr>       
  ...
  text-transform: uppercase; margin-left:10%" onmouseover="this.style.background='#9900FF'" onmouseout="this.style.background='#3b5999 '" /></td>
                ...
                <p style="height:20px" ></p>
                 <form name="form1" method="post" action="print.asp" target="_blank">
                 <input type="hidden" name="IDS" id="IDS" value="<%=Recordset1.Fields.Item("ID").Value%>">
                 <input type="submit" name="get" id="get" value="打印" style="font-size: 16px;
  font-weight: 300 !important;
  position:relative;
  color: #fff;
  cursor: pointer;
  ...
  -o-border-radius: 2px;
  margin-top:10px;
  text-transform: uppercase;margin-left:0%" onmouseover="this.style.background='#9900FF'" onmouseout="this.style.background='#3b5999 '" />
  
                 </form>
			      <a href="prove.asp"><input type="button" name="get" id="get" value="返回" style="font-size: 16px;
  font-weight: 300 !important;
  position:relative;
  color: #fff;
  cursor: pointer;
