...
%>
 ...
 <div id="list_wrap"><!--新闻内容-->
	<div id="list_main">
		<div class="maindiv">
				<div class="atshowa">
					<div class="atshowname" style="text-align:center;color:#009;font-size:23px;font-weight:bold;line-height:1.5em; font-family:'微软雅黑';margin-bottom:10px;height:auto!important">成绩单项目基本信息</div>
				  <div class="atshowb">
...
%>
                    ...
                    <input type="hidden" name="IDS" id="IDS" value="<%=Recordset7.Fields.Item("ID").Value%>">
				      ...
				      <td align="center"  style="max-width:300px"><%=(Recordset7.Fields.Item("备注").Value)%></td>
				      <td align="center"><input name="<%=("pass"&Recordset7.Fields.Item("ID").Value)%>" type="text" id="<%=("pass"&Recordset7.Fields.Item("ID").Value)%>"  placeholder="在此输入此项目通过的原因" value="通过"  ></td>
                      
				      <td align="center"><input name="<%=("nopass"&Recordset7.Fields.Item("ID").Value)%>" type="text" id="<%=("nopass"&Recordset7.Fields.Item("ID").Value)%>"  placeholder="在此输入此项目未通过的原因" value="不符合规范"  ></td>
                      <td width="11%" align="center"><input type="submit" name="get" id="get" value="通过" style="font-size: 16px;
  ...
  text-transform: uppercase;" onmouseover="this.style.background='#9900FF'" onmouseout="this.style.background='#00BBFF '" /></td>
                         <td width="11%" align="center"><input type="submit" name="get" id="get" value="拒绝" style="font-size: 16px;
  font-weight: 300 !important;
  position:relative;
  color: #fff;
  cursor: pointer;
  ...
  -moz-border-radius: 2px;
  -o-border-radius: 2px;
  text-transform: uppercase;" onmouseover="this.style.background='#9900FF'" onmouseout="this.style.background='#3b5999'" /></td>
   </form>
			        </tr>
